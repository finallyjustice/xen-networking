...
\title[Introduction to Xen Networking]{Introduction to Xen Networking} % The short title appears at the bottom of every slide, the full title is only on the title page
